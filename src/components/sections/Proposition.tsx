      ...
      <div className="container relative z-10">
        ...
        <div className="mt-12 border border-ink/15 bg-bone relative aa-reveal" style={{ transitionDelay: "120ms" }}>
          ...
          <div className="grid md:grid-cols-2">
            {/* Ще получиш column */}
            <div className="md:border-r border-ink/15">
              <div className="flex items-center gap-3 px-6 md:px-8 py-5 border-b border-ink/15">
            ...
            {/* Няма да получиш column */}
            <div className="border-t md:border-t-0 border-ink/15">
              <div className="flex items-center gap-3 px-6 md:px-8 py-5 border-b border-ink/15">
