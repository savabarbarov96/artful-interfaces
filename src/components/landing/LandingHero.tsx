...
const LandingHero = ({
  ...
  return (
    <section
      ref={heroRef}
      className="relative min-h-[85vh] flex items-center overflow-hidden grain-overlay bg-hero-gradient"
    >
      ...
      <div className="absolute -right-20 top-1/3 w-[280px] h-[280px] md:hidden pointer-events-none">
        <div
          ...
          style={{
            ...
            `,
            boxShadow:
              "0 0 60px hsl(217 91% 50% / 0.3), inset 0 0 40px hsl(0 0% 100% / 0.1)",
          }}
        />
      </div>
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, hsl(173 80% 60% / 0.25) 0%, transparent 70%)",
          filter: "blur(70px)",
      ...
      <svg
        className="absolute right-[10%] top-[20%] w-64 h-64 opacity-10 pointer-events-none hidden md:block"
        viewBox="0 0 200 200"
        style={{
      ...
      {/* Decorative lines */}
      <div
        className="absolute left-[15%] top-0 bottom-0 w-px pointer-events-none hidden md:block"
        style={{
          background:
            "linear-gradient(180deg, transparent 0%, hsl(0 0% 100% / 0.2) 30%, hsl(0 0% 100% / 0.2) 70%, transparent 100%)",
          transform: `scaleY(${1 - scrollY * 0.001})`,
        }}
      />
      <div
        className="absolute right-[20%] top-0 bottom-0 w-px pointer-events-none hidden md:block"
        style={{
          background:
            "linear-gradient(180deg, transparent 0%, hsl(0 0% 100% / 0.15) 40%, hsl(0 0% 100% / 0.15) 60%, transparent 100%)",
        }}
      />
        ...
        <div className="max-w-4xl">
          ...
          <div className="flex items-center gap-3 mb-8 animate-fade-up">
            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm border border-white/30 shadow-[0_10px_40px_rgba(255,255,255,0.12)]">
              ...
              <span className="text-label text-white">{eyebrow}</span>
            </div>
          </div>
          ...
          {/* Subtitle */}
          <p className="text-xl md:text-2xl text-white max-w-2xl mb-12 leading-relaxed animate-fade-up delay-200 font-body font-medium drop-shadow-[0_6px_22px_rgba(255,255,255,0.22)]">
            {subtitle}
          </p>
      ...
      {technologies && technologies.length > 0 && (
        <div className="absolute bottom-0 left-0 right-0 bg-white/10 backdrop-blur-lg border-t border-white/20 z-20 shadow-[0_-12px_40px_rgba(255,255,255,0.08)]">
      ...
      {/* Scroll indicator */}
      <div
        className="absolute bottom-32 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 animate-fade-up delay-500 pointer-events-none"
        style={{ opacity: Math.max(0, 1 - scrollY * 0.005) }}
      >
        <span className="text-white/70 text-xs font-body uppercase tracking-widest">
          Scroll
        </span>
