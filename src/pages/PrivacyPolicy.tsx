      ...
      <main className="pt-28 lg:pt-32 pb-20">
        <section className="container">
          <div className="max-w-4xl">
            <p className="text-label text-primary mb-4">Legal</p>
            <h1 className="text-display-lg text-foreground mb-3">
              Privacy Policy for Automation Aid
            </h1>
            ...
            <div className="space-y-10 text-foreground/90 font-body leading-relaxed">
              <section className="space-y-4">
                <h2 className="text-display-md text-foreground">Privacy Policy</h2>
                <p>
              ...
              <section className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <ul className="space-y-3 list-disc pl-6 text-foreground/85">
                    <li>
                    ...
                    <li>
                      ...
                      or "Our" in this Privacy Policy) refers to AutomationAid,
                      Разл.
                    </li>
                    <li>
                    ...
                    <li>
                      Website refers to Automation Aid, accessible from
                      https://automationaid.eu.
                    </li>
                    <li>
              ...
              <section className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <ul className="space-y-2 list-disc pl-6 text-foreground/85">
                      <li>Email address</li>
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-3 list-disc pl-6 text-foreground/85">
                    <li>
                      ...
                      on Your Device. You can instruct Your browser to refuse
              ...
              <section className="space-y-4">
                ...
                <div className="space-y-3">
                  <p className="font-semibold text-foreground">Customer Support Data</p>
                  <p>
                ...
                <div className="space-y-3">
                  ...
                  <p>
                    ...
                    periods described above, and may be retained longer only
                    where necessary for security, fraud prevention, or legal
                    compliance.
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  <p>
                    ...
                    anonymize Personal Data according to the following
                    procedures:
                  </p>
                  <ul className="space-y-2 list-disc pl-6 text-foreground/85">
                    <li>
              ...
              <section className="space-y-4">
                ...
                <div className="space-y-3">
                  <h3 className="text-xl font-display text-foreground">Business Transactions</h3>
                  <p>
                ...
                <div className="space-y-3">
                  <h3 className="text-xl font-display text-foreground">Law enforcement</h3>
                  <p>
              ...
              <section className="space-y-4">
                <h2 className="text-display-md text-foreground">Children's Privacy</h2>
                <p>
                  ...
                  collected Personal Data from anyone under the age of 16
              ...
              <section className="space-y-4">
                <h2 className="text-display-md text-foreground">Contact Us</h2>
                <p>
                  If you have any questions about this Privacy Policy, You can
                  contact us:
                </p>
                <p>By email: support@automationaid.eu</p>
              </section>
            </div>
          </div>
        </section>
