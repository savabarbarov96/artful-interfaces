...
const aiFaqs: FAQItem[] = [
  ...
  {
    question: "Каква е разликата между AI интеграция и AI агент?",
    answer:
      "Искате AI в съществуващите си процеси? Вижте AI интеграция — точно тази страница. Искате автономен AI агент да е основният ви продукт/двигател за продажби или поддръжка? Вижте AI агенти.",
  },
];
          ...
          services={[
            {
              title: "AI агенти",
              description:
                "Автономен AI агент за продажби, поддръжка или операции — не чатбот над съществуващ процес, а самостоятелен двигател.",
              href: "/ai-agents",
              icon: Bot,
            },
            {
